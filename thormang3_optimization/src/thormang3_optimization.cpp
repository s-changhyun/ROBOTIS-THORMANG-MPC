...
bool getPreviewMatrixCallback(thormang3_wholebody_module_msgs::GetPreviewMatrix::Request& req,
                              thormang3_wholebody_module_msgs::GetPreviewMatrix::Response& res)
{
...
{
  ros::init(argc, argv, "thormang3_optimization");
  ros::NodeHandle nh("~");
